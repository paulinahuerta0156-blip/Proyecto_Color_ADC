...
#define BTN_2 GPIO_NUM_13   // Congelar / descongelar.
...
int congelado = 0;   // 0 = activo, 1 = congelado.

// Variables para detectar flanco (botón).
...
void app_main(void)
{
    ...
    {
        // ===================================
        // LECTURA DEL BOTÓN 1: CAMBIAR MODO
        // ===================================
        ...
        if (b2 == 0 && estado_anterior_b2 == 1)
        {
            ...
            if (congelado)
                printf("MEDICION CONGELADA\n");
            else
                printf("MEDICION REANUDADA\n");
        }

        estado_anterior_b2 = b2;
        
        // Mediciones si no hay congelamiento.
